var ctx1 = document.getElementById("lineChart").getContext("2d"),
  myChart =
    ...
    new Chart(ctx1, {
      ...
      options: {
        ...
        plugins: {
          legend: {
            labels: { color: "#7c8ea7", font: { family: "Be Vietnam Pro" } },
          },
        },
        scales: {
          y: {
  ...
  ctx4 = document.getElementById("polarArea").getContext("2d"),
  myChart =
    ((Chart.defaults.font.family = "Be Vietnam Pro"),
    new Chart(ctx4, {
      type: "polarArea",
  ...
  ctx5 = document.getElementById("pie").getContext("2d"),
  myChart =
    ((Chart.defaults.font.family = "Be Vietnam Pro"),
    new Chart(ctx5, {
      type: "pie",
  ...
  ctx6 = document.getElementById("radar").getContext("2d"),
  myChart =
    ((Chart.defaults.font.family = "Be Vietnam Pro"),
    new Chart(ctx6, {
      type: "radar",
      ...
      options: {
        ...
        scales: {
          r: {
            ...
            grid: { color: "rgba(137, 153, 175, 0.3)" },
          },
        },
        plugins: {
          legend: {
